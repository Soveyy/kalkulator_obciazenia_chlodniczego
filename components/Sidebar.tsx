        ...
        <>
            ...
            <aside 
                className={`
                    ...
                    lg:relative lg:inset-auto lg:z-auto lg:h-auto lg:w-80 lg:rounded-none lg:shadow-none lg:translate-y-0 lg:translate-x-0
                `}
            >
                ...
                <div className="flex-1 overflow-y-auto space-y-6 pb-4 -mr-2 pr-2">
                    {/* Project Management */}
                    <Card>
